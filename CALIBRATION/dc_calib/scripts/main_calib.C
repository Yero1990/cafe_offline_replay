...
int main_calib()
{
  ...
  //DC_calib obj("HMS", "../../../ROOTfiles/hms_replay_production_all_4407_dcUnCalib.root", 4407, -1, "pid_elec", "card");
  DC_calib obj("SHMS", "../../../ROOTfiles/shms_replay_production_all_17243_dcUnCalib.root", 17243, -1, "pid_elec", "card");  
