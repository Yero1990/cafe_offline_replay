...
int main_calib()
{
  ...
  //DC_calib obj("HMS", "../../../ROOTfiles/dccalib/cafe_replay_dccalib_14967_2M_dcUnCalib.root", 14967, -1, "pid_elec", "card");
  DC_calib obj("SHMS", "../../../ROOTfiles/dccalib/cafe_replay_dccalib_14967_2M_dcUnCalib.root", 14967, -1, "pid_elec", "card");
