...
`step 1:` Go to [https://github.com/Yero1990/cafe\_offline\_replay](https://github.com/Yero1990/cafe_offline_replay) and fork a copy to your own repo.<br>
...
$ git clone https://github.com/your_github_username/cafe_offline_replay 
$ cd cafe_offline_replay 

# track the upstram branch is needed to keep your forked copy and local machine copy up-to-date 
$ git remote add --track master upstream https://github.com/Yero1990/cafe_offline_replay 

# check that the track to the remote branches origin and upstream are specified
$ git remote -v  
```

`step 3:` To make any contributions locally and save it to the official [https://github.com/Yero1990/cafe\_offline\_replay](https://github.com/Yero1990/cafe_offline_replay) repository, do:
...
# save the changes to your remote forked copy of the cafe_offline_replay repo 
$ git push origin work_branch

# make a pull request to incorporate the changes into the official cafe_offline_replay

   a) Go to:  https://github.com/your_github_username/cafe_offline_replay and select the work_branch
